...
__all__ = ('DFL', 'HGBlock', 'HGStem', 'SPP', 'SPPF', 'C1', 'C2', 'C3', 'C2f', 'C3x', 'C3TR', 'C3Ghost',
           'GhostBottleneck', 'Bottleneck', 'BottleneckCSP', 'Proto', 'RepC3','C3STR')
...
class SwinTransformerLayer(nn.Module):
    ...
    def create_mask(self, x, H, W):
        ...
        HH = torch.tensor(H) / self.window_size
        WW = torch.tensor(W) / self.window_size
        Hp = HH.ceil() * self.window_size
        Wp = WW.ceil() * self.window_size
        # 拥有和feature map一样的通道排列顺序，方便后续window_partition
        img_mask = torch.zeros((1, int(Hp), int(Wp), 1))  # [1, Hp, Wp, 1]
